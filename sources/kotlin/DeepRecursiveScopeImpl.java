    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (cont2 == null) {
                ...
                return result2;
            } else if (Result.m63equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, result2)) {
                try {
                    ...
                    if (r != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                        ...
                        cont2.resumeWith(Result.m61constructorimpl(r));
                    }
                } catch (Throwable e) {
                    Result.Companion companion2 = Result.Companion;
                    cont2.resumeWith(Result.m61constructorimpl(ResultKt.createFailure(e)));
                }
            } else {
