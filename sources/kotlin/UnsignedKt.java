...
public final class UnsignedKt {
    ...
    public static final int m408uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m155constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }

    /* renamed from: uintRemainder-J1ME1BU  reason: not valid java name */
    public static final int m409uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m155constructorimpl((int) ((((long) v1) & 4294967295L) % (4294967295L & ((long) v2))));
    }

    /* renamed from: ulongDivide-eb3DHEI  reason: not valid java name */
    public static final long m410ulongDivideeb3DHEI(long v1, long v2) {
        long dividend = v1;
        long divisor = v2;
        long j = 0;
        if (divisor < 0) {
            ...
            return ULong.m233constructorimpl(dividend / divisor);
        } else {
            int i = 1;
            long quotient = ((dividend >>> 1) / divisor) << 1;
            if (ulongCompare(ULong.m233constructorimpl(dividend - (quotient * divisor)), ULong.m233constructorimpl(divisor)) < 0) {
                i = 0;
            }
            return ULong.m233constructorimpl(((long) i) + quotient);
        }
    }

    /* renamed from: ulongRemainder-eb3DHEI  reason: not valid java name */
    public static final long m411ulongRemaindereb3DHEI(long v1, long v2) {
        long dividend = v1;
        long divisor = v2;
        long j = 0;
        if (divisor < 0) {
            ...
            return ULong.m233constructorimpl(v1 - v2);
        } else if (dividend >= 0) {
            return ULong.m233constructorimpl(dividend % divisor);
        } else {
            long rem = dividend - ((((dividend >>> 1) / divisor) << 1) * divisor);
            if (ulongCompare(ULong.m233constructorimpl(rem), ULong.m233constructorimpl(divisor)) >= 0) {
                j = divisor;
            }
            return ULong.m233constructorimpl(rem - j);
        }
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        if (v <= 2.147483647E9d) {
            return UInt.m155constructorimpl((int) v);
        }
        return UInt.m155constructorimpl(UInt.m155constructorimpl((int) (v - ((double) Integer.MAX_VALUE))) + UInt.m155constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        if (v < 9.223372036854776E18d) {
            return ULong.m233constructorimpl((long) v);
        }
        return ULong.m233constructorimpl(ULong.m233constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
