...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> $this$toUByteArray) {
        ...
        byte[] result = UByteArray.m130constructorimpl($this$toUByteArray.size());
        int index = 0;
        for (UByte r3 : $this$toUByteArray) {
            UByteArray.m141setVurrAj0(result, index, r3.m128unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> $this$toUIntArray) {
        ...
        int[] result = UIntArray.m208constructorimpl($this$toUIntArray.size());
        int index = 0;
        for (UInt r3 : $this$toUIntArray) {
            UIntArray.m219setVXSXFK8(result, index, r3.m206unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> $this$toULongArray) {
        ...
        long[] result = ULongArray.m286constructorimpl($this$toULongArray.size());
        int index = 0;
        for (ULong r3 : $this$toULongArray) {
            ULongArray.m297setk8EXiF4(result, index, r3.m284unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> $this$toUShortArray) {
        ...
        short[] result = UShortArray.m390constructorimpl($this$toUShortArray.size());
        int index = 0;
        for (UShort r3 : $this$toUShortArray) {
            UShortArray.m401set01HTLdE(result, index, r3.m388unboximpl());
            index++;
        }
        return result;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> $this$sum) {
        ...
        for (UInt r2 : $this$sum) {
            sum = UInt.m155constructorimpl(sum + r2.m206unboximpl());
        }
        return sum;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> $this$sum) {
        ...
        for (ULong r3 : $this$sum) {
            sum = ULong.m233constructorimpl(sum + r3.m284unboximpl());
        }
        return sum;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> $this$sum) {
        ...
        for (UByte r2 : $this$sum) {
            sum = UInt.m155constructorimpl(UInt.m155constructorimpl(r2.m128unboximpl() & UByte.MAX_VALUE) + sum);
        }
        return sum;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> $this$sum) {
        ...
        for (UShort r2 : $this$sum) {
            sum = UInt.m155constructorimpl(UInt.m155constructorimpl(65535 & r2.m388unboximpl()) + sum);
        }
        return sum;
    }
}
