...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int start, int endInclusive, int step2) {
        if (step2 == 0) {
            ...
            this.first = start;
            this.last = UProgressionUtilKt.m1272getProgressionLastElementNkh28Cs(start, endInclusive, step2);
            this.step = step2;
        } else {
    ...
    public final int m1286getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA  reason: not valid java name */
    public final int m1287getLastpVg5ArA() {
        return this.last;
    }
    ...
    public String toString() {
        ...
        StringBuilder sb;
        if (this.step > 0) {
            sb = new StringBuilder().append(UInt.m200toStringimpl(this.first)).append("..").append(UInt.m200toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder().append(UInt.m200toStringimpl(this.first)).append(" downTo ").append(UInt.m200toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1288fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
