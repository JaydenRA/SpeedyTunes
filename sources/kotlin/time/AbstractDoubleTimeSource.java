...
public abstract class AbstractDoubleTimeSource implements TimeSource {
    ...
    private static final class DoubleTimeMark implements TimeMark {
        ...
        public TimeMark m1361minusLRDsOJo(long duration) {
            return TimeMark.DefaultImpls.m1512minusLRDsOJo(this, duration);
        }
        ...
        public TimeMark m1362plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1410plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }
    }

    public TimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m1476getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
