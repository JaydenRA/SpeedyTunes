...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark m1368minusLRDsOJo(long duration) {
    ...
    public long m1366elapsedNowUwyO8pc() {
        return Duration.m1409minusLRDsOJo(this.mark.m1509elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1369plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1410plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
