...
public final class MeasureTimeKt {
    public static final long measureTime(Function0<Unit> block) {
        ...
        long mark$iv = TimeSource.Monotonic.INSTANCE.m1514markNowz9LOYto();
        block.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m1517elapsedNowUwyO8pc(mark$iv);
    }
    ...
    public static final long measureTime(TimeSource $this$measureTime, Function0<Unit> block) {
        ...
        block.invoke();
        return mark.m1509elapsedNowUwyO8pc();
    }

    public static final long measureTime(TimeSource.Monotonic $this$measureTime, Function0<Unit> block) {
        Intrinsics.checkNotNullParameter($this$measureTime, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        long mark = $this$measureTime.m1514markNowz9LOYto();
        block.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m1517elapsedNowUwyO8pc(mark);
    }

    public static final <T> TimedValue<T> measureTimedValue(Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), TimeSource.Monotonic.ValueTimeMark.m1517elapsedNowUwyO8pc(TimeSource.Monotonic.INSTANCE.m1514markNowz9LOYto()), (DefaultConstructorMarker) null);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(TimeSource $this$measureTimedValue, Function0<? extends T> block) {
        ...
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), $this$measureTimedValue.markNow().m1509elapsedNowUwyO8pc(), (DefaultConstructorMarker) null);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(TimeSource.Monotonic $this$measureTimedValue, Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter($this$measureTimedValue, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), TimeSource.Monotonic.ValueTimeMark.m1517elapsedNowUwyO8pc($this$measureTimedValue.m1514markNowz9LOYto()), (DefaultConstructorMarker) null);
    }
}
