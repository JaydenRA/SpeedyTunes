...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1532copyRFiDyg4$default(TimedValue timedValue, T t, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            t = timedValue.value;
        }
        if ((i & 2) != 0) {
        ...
        return timedValue.m1534copyRFiDyg4(t, j);
    }
    ...
    public final long m1533component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m1534copyRFiDyg4(T t, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.value, (Object) timedValue.value) && Duration.m1379equalsimpl0(this.duration, timedValue.duration);
    }
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1423toStringimpl(this.duration) + ')';
    }
    ...
    public final long m1535getDurationUwyO8pc() {
        return this.duration;
    }
