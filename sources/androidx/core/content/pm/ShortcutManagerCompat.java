...
public class ShortcutManagerCompat {
    ...
    public static boolean pushDynamicShortcut(android.content.Context r7, androidx.core.content.pm.ShortcutInfoCompat r8) {
        ...
        L_0x0094:
            ...
            java.lang.String[] r5 = new java.lang.String[r1]     // Catch:{ Exception -> 0x0106, all -> 0x00e1 }
            java.lang.String r6 = getShortcutInfoCompatWithLowestRank(r4)     // Catch:{ Exception -> 0x0106, all -> 0x00e1 }
            r5[r2] = r6     // Catch:{ Exception -> 0x0106, all -> 0x00e1 }
        ...
        L_0x00b1:
            androidx.core.content.pm.ShortcutInfoCompat[] r5 = new androidx.core.content.pm.ShortcutInfoCompat[r1]     // Catch:{ Exception -> 0x0106, all -> 0x00e1 }
            r5[r2] = r8     // Catch:{ Exception -> 0x0106, all -> 0x00e1 }
            java.util.List r5 = java.util.Arrays.asList(r5)     // Catch:{ Exception -> 0x0106, all -> 0x00e1 }
