...
public class IntentSanitizer {
    ...
    public Intent sanitizeByFiltering(Intent in) {
        return sanitize(in, IntentSanitizer$$ExternalSyntheticLambda0.INSTANCE);
    }

    public Intent sanitizeByThrowing(Intent in) {
        return sanitize(in, IntentSanitizer$$ExternalSyntheticLambda1.INSTANCE);
    }
    ...
    public static final class Builder {
        ...
        public Builder allowAction(String action) {
            ...
            allowAction((Predicate<String>) new IntentSanitizer$Builder$$ExternalSyntheticLambda16(action));
            return this;
        }
        ...
        public Builder allowDataWithAuthority(String authority) {
            ...
            allowData(new IntentSanitizer$Builder$$ExternalSyntheticLambda13(authority));
            return this;
        }
        ...
        public Builder allowType(String type) {
            ...
            return allowType((Predicate<String>) new IntentSanitizer$Builder$$ExternalSyntheticLambda16(type));
        }
        ...
        public Builder allowCategory(String category) {
            ...
            return allowCategory((Predicate<String>) new IntentSanitizer$Builder$$ExternalSyntheticLambda16(category));
        }
        ...
        public Builder allowPackage(String packageName) {
            ...
            return allowPackage((Predicate<String>) new IntentSanitizer$Builder$$ExternalSyntheticLambda16(packageName));
        }
        ...
        public Builder allowComponent(ComponentName component) {
            ...
            return allowComponent((Predicate<ComponentName>) new IntentSanitizer$Builder$$ExternalSyntheticLambda0(component));
        }
        ...
        public Builder allowComponentWithPackage(String packageName) {
            Preconditions.checkNotNull(packageName);
            return allowComponent((Predicate<ComponentName>) new IntentSanitizer$Builder$$ExternalSyntheticLambda11(packageName));
        }
        ...
        public Builder allowClipDataUriWithAuthority(String authority) {
            Preconditions.checkNotNull(authority);
            return allowClipDataUri(new IntentSanitizer$Builder$$ExternalSyntheticLambda12(authority));
        }
        ...
        public Builder allowExtra(String key, Class<?> clazz) {
            return allowExtra(key, clazz, IntentSanitizer$Builder$$ExternalSyntheticLambda8.INSTANCE);
        }
        ...
        public <T> Builder allowExtra(String key, Class<T> clazz, Predicate<T> valueFilter) {
            ...
            return allowExtra(key, (Predicate<Object>) new IntentSanitizer$Builder$$ExternalSyntheticLambda10(clazz, valueFilter));
        }
        ...
        public Builder allowExtra(String key, Predicate<Object> filter) {
            ...
            if (allowedExtra == null) {
                allowedExtra = IntentSanitizer$Builder$$ExternalSyntheticLambda9.INSTANCE;
            }
        ...
        public Builder allowExtraStreamUriWithAuthority(String uriAuthority) {
            ...
            allowExtra("android.intent.extra.STREAM", Uri.class, new IntentSanitizer$Builder$$ExternalSyntheticLambda15(uriAuthority));
            return this;
        }
        ...
        public Builder allowExtraOutput(String uriAuthority) {
            allowExtra("output", Uri.class, new IntentSanitizer$Builder$$ExternalSyntheticLambda14(uriAuthority));
            return this;
        }
