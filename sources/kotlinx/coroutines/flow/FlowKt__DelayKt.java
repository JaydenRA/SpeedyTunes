...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1586debounceHG0u8IE(Flow<? extends T> $this$debounce, long timeout) {
        return FlowKt.debounce($this$debounce, DelayKt.m1539toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final <T> Flow<T> m1587sampleHG0u8IE(Flow<? extends T> $this$sample, long period) {
        return FlowKt.sample($this$sample, DelayKt.m1539toDelayMillisLRDsOJo(period));
    }
}
