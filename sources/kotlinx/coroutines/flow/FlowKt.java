...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1583catch(Flow<? extends T> $this$catch, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> action) {
        return FlowKt__ErrorsKt.m1590catch($this$catch, action);
    }
    ...
    public static final <T> Flow<T> m1584debounceHG0u8IE(Flow<? extends T> $this$debounce, long timeout) {
        return FlowKt__DelayKt.m1586debounceHG0u8IE($this$debounce, timeout);
    }
    ...
    public static final <T> Flow<T> m1585sampleHG0u8IE(Flow<? extends T> $this$sample, long period) {
        return FlowKt__DelayKt.m1587sampleHG0u8IE($this$sample, period);
    }
