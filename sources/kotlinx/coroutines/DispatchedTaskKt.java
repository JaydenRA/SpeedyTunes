...
public final class DispatchedTaskKt {
    ...
    public static final <T> void resume(DispatchedTask<? super T> $this$resume, Continuation<? super T> delegate, boolean undispatched) {
        ...
        Object result = Result.m61constructorimpl(exception != null ? ResultKt.createFailure(exception) : $this$resume.getSuccessfulResult$kotlinx_coroutines_core(state));
        if (undispatched) {
    ...
    public static final void resumeWithStackTrace(Continuation<?> $this$resumeWithStackTrace, Throwable exception) {
        ...
        $this$resumeWithStackTrace.resumeWith(Result.m61constructorimpl(ResultKt.createFailure(th)));
    }
}
