...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m61constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), (String) null, 2, (DefaultConstructorMarker) null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m61constructorimpl(ResultKt.createFailure(th));
        }
        if (!Result.m67isFailureimpl(obj)) {
    ...
    public static final void m1546postFrameCallback$lambda6(CancellableContinuation $cont, long nanos) {
