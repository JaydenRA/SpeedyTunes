...
final class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(CancellableContinuation<? super Unit> cont) {
        ...
        while (true) {
            ...
            while (true) {
                if (cur$iv$iv.getId() >= id$iv && !cur$iv$iv.getRemoved()) {
                    obj = SegmentOrClosed.m1605constructorimpl(cur$iv$iv);
                    curTail = next$iv$iv;
                    break;
                }
                ...
                if (it$iv$iv$iv == ConcurrentLinkedListKt.CLOSED) {
                    obj = SegmentOrClosed.m1605constructorimpl(ConcurrentLinkedListKt.CLOSED);
                    break;
                }
            ...
            s$iv = obj;
            if (SegmentOrClosed.m1610isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m1608getSegmentimpl(s$iv);
            while (true) {
        ...
        SemaphoreSegment segment = (SemaphoreSegment) SegmentOrClosed.m1608getSegmentimpl(s$iv);
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        L_0x001c:
            ...
            goto L_0x0030
        L_0x002b:
            java.lang.Object r11 = kotlinx.coroutines.internal.SegmentOrClosed.m1605constructorimpl(r10)
            goto L_0x004a
        L_0x0030:
            r11 = r10
            ...
            java.lang.Object r16 = kotlinx.coroutines.internal.SegmentOrClosed.m1605constructorimpl(r16)
            r11 = r16
        L_0x004a:
            r8 = r11
            boolean r9 = kotlinx.coroutines.internal.SegmentOrClosed.m1610isClosedimpl(r8)
            if (r9 != 0) goto L_0x0096
            kotlinx.coroutines.internal.Segment r9 = kotlinx.coroutines.internal.SegmentOrClosed.m1608getSegmentimpl(r8)
            r12 = r6
            r13 = 0
            r14 = r12
            r15 = 0
        ...
        L_0x0094:
            goto L_0x0059
        L_0x0096:
            kotlinx.coroutines.internal.Segment r6 = kotlinx.coroutines.internal.SegmentOrClosed.m1608getSegmentimpl(r8)
