...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Object m1550trySendJP2dKIU(E element) {
        ...
        if (result == AbstractChannelKt.OFFER_FAILED) {
            ...
            return ChannelResult.Companion.m1572closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        } else if (result instanceof Closed) {
            return ChannelResult.Companion.m1572closedJP2dKIU(helpCloseAndGetSendException((Closed) result));
        } else {
    ...
    public final Object sendSuspend(E element, Continuation<? super Unit> $completion) {
        ...
        while (true) {
            ...
            if (offerResult == AbstractChannelKt.OFFER_SUCCESS) {
                ...
                cont.resumeWith(Result.m61constructorimpl(Unit.INSTANCE));
                break;
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> $this$helpCloseAndResumeWithSendException, E element, Closed<?> closed) {
        ...
        if (function1 == null || (it = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, element, (UndeliveredElementException) null, 2, (Object) null)) == null) {
            Result.Companion companion = Result.Companion;
            $this$helpCloseAndResumeWithSendException.resumeWith(Result.m61constructorimpl(ResultKt.createFailure(sendException)));
            return;
        }
        ExceptionsKt.addSuppressed(it, sendException);
        Result.Companion companion2 = Result.Companion;
        $this$helpCloseAndResumeWithSendException.resumeWith(Result.m61constructorimpl(ResultKt.createFailure(it)));
    }
    ...
    private final void helpClose(Closed<?> closed) {
        Object closedList = InlineList.m1596constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
        while (true) {
            ...
            if (previous == null) {
                ...
                closedList = InlineList.m1601plusFjFbRPM(closedList, previous);
            }
        }
        if (closedList != null) {
