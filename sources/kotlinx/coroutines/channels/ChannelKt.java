...
public final class ChannelKt {
    ...
    public static final <T> T m1555getOrElseWpGqRn0(Object $this$getOrElse, Function1<? super Throwable, ? extends T> onFailure) {
        return $this$getOrElse instanceof ChannelResult.Failed ? onFailure.invoke(ChannelResult.m1563exceptionOrNullimpl($this$getOrElse)) : $this$getOrElse;
    }

    /* renamed from: onSuccess-WpGqRn0  reason: not valid java name */
    public static final <T> Object m1558onSuccessWpGqRn0(Object $this$onSuccess, Function1<? super T, Unit> action) {
    ...
    public static final <T> Object m1557onFailureWpGqRn0(Object $this$onFailure, Function1<? super Throwable, Unit> action) {
        if ($this$onFailure instanceof ChannelResult.Failed) {
            action.invoke(ChannelResult.m1563exceptionOrNullimpl($this$onFailure));
        }
        return $this$onFailure;
    }

    /* renamed from: onClosed-WpGqRn0  reason: not valid java name */
    public static final <T> Object m1556onClosedWpGqRn0(Object $this$onClosed, Function1<? super Throwable, Unit> action) {
        if ($this$onClosed instanceof ChannelResult.Closed) {
            action.invoke(ChannelResult.m1563exceptionOrNullimpl($this$onClosed));
        }
