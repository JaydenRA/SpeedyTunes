...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.lang.Object m1548receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r6) {
        /*
            r5 = this;
        ...
        L_0x0032:
            ...
            java.lang.Object r3 = r3.m1572closedJP2dKIU(r4)
            goto L_0x0056
        L_0x0050:
            kotlinx.coroutines.channels.ChannelResult$Companion r3 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r3 = r3.m1574successJP2dKIU(r1)
        L_0x0056:
            return r3
        L_0x0057:
            r3 = 1
        ...
        L_0x0061:
            ...
            java.lang.Object r1 = r2.m1571unboximpl()
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.m1548receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: tryReceive-PtdJZtk  reason: not valid java name */
    public final Object m1549tryReceivePtdJZtk() {
        Object result = pollInternal();
        if (result == AbstractChannelKt.POLL_FAILED) {
            return ChannelResult.Companion.m1573failurePtdJZtk();
        }
        if (result instanceof Closed) {
            return ChannelResult.Companion.m1572closedJP2dKIU(((Closed) result).closeCause);
        }
        return ChannelResult.Companion.m1574successJP2dKIU(result);
    }
    ...
    public void onCancelIdempotent(boolean wasClosed) {
        ...
        if (closed != null) {
            Object list = InlineList.m1596constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
            while (true) {
                LockFreeLinkedListNode previous = closed.getPrevNode();
                if (previous instanceof LockFreeLinkedListHead) {
                    m1547onCancelIdempotentListww6eGU(list, closed);
                    return;
                    ...
                    list = InlineList.m1601plusFjFbRPM(list, (Send) previous);
                }
            }
        } else {
    ...
    public void m1547onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list != null) {
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> $this$tryStartBlockUnintercepted, SelectInstance<? super R> select, int receiveMode, Object value) {
        if (value instanceof Closed) {
            switch (receiveMode) {
                ...
                case 1:
                    if (select.trySelect()) {
                        UndispatchedKt.startCoroutineUnintercepted($this$tryStartBlockUnintercepted, ChannelResult.m1559boximpl(ChannelResult.Companion.m1572closedJP2dKIU(((Closed) value).closeCause)), select.getCompletion());
                        return;
                    }
                    return;
                default:
            ...
            UndispatchedKt.startCoroutineUnintercepted($this$tryStartBlockUnintercepted, ChannelResult.m1559boximpl($this$toResult$iv instanceof Closed ? ChannelResult.Companion.m1572closedJP2dKIU(((Closed) $this$toResult$iv).closeCause) : ChannelResult.Companion.m1574successJP2dKIU($this$toResult$iv)), select.getCompletion());
        } else {
            ...
            while (true) {
                ...
                if (result2 instanceof Closed) {
                    if (((Closed) result2).closeCause == null) {
                        ...
                        cont.resumeWith(Result.m61constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.Companion;
                        cont.resumeWith(Result.m61constructorimpl(ResultKt.createFailure(((Closed) result2).getReceiveException())));
                    }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            if (this.receiveMode == 1) {
                return ChannelResult.m1559boximpl(ChannelResult.Companion.m1574successJP2dKIU(value));
            }
            return value;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m61constructorimpl(ChannelResult.m1559boximpl(ChannelResult.Companion.m1572closedJP2dKIU(closed.closeCause))));
                return;
            }
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m61constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E value) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1559boximpl(ChannelResult.Companion.m1574successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
            ...
            if (this.select.trySelect()) {
                switch (this.receiveMode) {
                    case 0:
                        ...
                        return;
                    case 1:
                        CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1559boximpl(ChannelResult.Companion.m1572closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), (Function1) null, 4, (Object) null);
                        return;
                    default:
                        return;
                }
