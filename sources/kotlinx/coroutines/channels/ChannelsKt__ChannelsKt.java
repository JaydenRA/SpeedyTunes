...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    public static final <E> Object trySendBlocking(SendChannel<? super E> $this$trySendBlocking, E element) {
        Object $this$onSuccess$iv = $this$trySendBlocking.m1581trySendJP2dKIU(element);
        if ($this$onSuccess$iv instanceof ChannelResult.Failed) {
            return ((ChannelResult) BuildersKt__BuildersKt.runBlocking$default((CoroutineContext) null, new ChannelsKt__ChannelsKt$trySendBlocking$2($this$trySendBlocking, element, (Continuation<? super ChannelsKt__ChannelsKt$trySendBlocking$2>) null), 1, (Object) null)).m1571unboximpl();
        }
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> $this$sendBlocking, E element) {
        if (!ChannelResult.m1569isSuccessimpl($this$sendBlocking.m1581trySendJP2dKIU(element))) {
