...
public final class AbstractChannelKt {
    ...
    private static final <E> Object toResult(Object $this$toResult) {
        return $this$toResult instanceof Closed ? ChannelResult.Companion.m1572closedJP2dKIU(((Closed) $this$toResult).closeCause) : ChannelResult.Companion.m1574successJP2dKIU($this$toResult);
    }

    private static final <E> Object toResult(Closed<?> $this$toResult) {
        return ChannelResult.Companion.m1572closedJP2dKIU($this$toResult.closeCause);
    }
}
