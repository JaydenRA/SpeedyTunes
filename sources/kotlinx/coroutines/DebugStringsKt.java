...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> $this$toDebugString) {
        ...
        try {
            ...
            str = Result.m61constructorimpl($this$toDebugString_u24lambda_u2d0 + '@' + getHexAddress($this$toDebugString_u24lambda_u2d0));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            str = Result.m61constructorimpl(ResultKt.createFailure(th));
        }
        Throwable r2 = Result.m64exceptionOrNullimpl(str);
        if (r2 != null) {
            Throwable th2 = r2;
