...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E exception) {
        ...
        try {
            ...
            e = Result.m61constructorimpl(((CopyableThrowable) exception).createCopy());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            e = Result.m61constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m67isFailureimpl(e)) {
            e = null;
        }
        return (Throwable) e;
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> $this$fieldsCountOrDefault, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            num = Result.m61constructorimpl(Integer.valueOf(fieldsCount$default($this$fieldsCountOrDefault, 0, 1, (Object) null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            num = Result.m61constructorimpl(ResultKt.createFailure(th));
        }
        Integer valueOf = Integer.valueOf(defaultValue);
        if (Result.m67isFailureimpl(num)) {
            num = valueOf;
        }
