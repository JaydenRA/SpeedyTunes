...
public final class DelayKt {
    ...
    public static final Object m1538delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m1539toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m1539toDelayMillisLRDsOJo(long $this$toDelayMillis) {
        if (Duration.m1373compareToLRDsOJo($this$toDelayMillis, Duration.Companion.m1476getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1392getInWholeMillisecondsimpl($this$toDelayMillis), 1);
        }
        return 0;
    }
}
