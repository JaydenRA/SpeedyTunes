...
public final class TimeoutKt {
    ...
    public static final <T> Object m1542withTimeoutKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
        return withTimeout(DelayKt.m1539toDelayMillisLRDsOJo(timeout), block, $completion);
    }
    ...
    public static final <T> Object m1543withTimeoutOrNullKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
        return withTimeoutOrNull(DelayKt.m1539toDelayMillisLRDsOJo(timeout), block, $completion);
    }
